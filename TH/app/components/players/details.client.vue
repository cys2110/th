...
const details = computed(() => [
  {
    label: "Rankings",
    class: "row-span-2",
    value: <div class="grid grid-rows-4 grid-flow-col gap-1 text-center">{rankings.value.map(item => item)}</div>
  },
  ...(props.player.age
    ? [
        {
  ...
  ...(props.player.turned_pro || props.player.retired
    ? [
        {
          label: props.player.turned_pro && props.player.retired ? "Pro Years" : props.player.turned_pro ? "Turned Pro" : "Retired",
          value: (
            <>
              <div>
                {props.player.turned_pro && props.player.retired
            ...
            <div>
              {props.player.former_countries.map(country => (
                <div
                  ...
                  class="flex items-center gap-2"
                >
                  <countries-link country={country} />
