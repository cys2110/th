    ...
    <template #body>
      ...
      >
        <template #tooltip="params">
          ...
          >
            <div
              v-if="(isDefined(((param as CallbackDataParams).value as WLIndexType).titles) && (param as CallbackDataParams).seriesIndex === 1) || (param as CallbackDataParams).seriesIndex === 0"
