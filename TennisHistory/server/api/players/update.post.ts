export default defineEventHandler(async event => {
  ...
  if ("hof" in params && params.hof !== undefined) {
    query += `
      WITH p
  ...
  if ("turned_pro" in params && params.turned_pro !== undefined) {
    query += `
      WITH p
  ...
  if ("retired" in params && params.retired !== undefined) {
    query += `
      WITH p
  ...
  if ("former_countries" in params && params.former_countries !== undefined) {
    query += `
      WITH p
  ...
  if ("coaches" in params && params.coaches !== undefined) {
    query += `
      WITH p
  ...
  if ("former_coaches" in params && params.former_coaches !== undefined) {
    query += `
      WITH p
