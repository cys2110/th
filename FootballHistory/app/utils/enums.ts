...
export const MatchEventType = z.enum(
  ["goal", "red_card", "yellow_card", "second_yellow_card", "penalty_missed", "penalty_saved", "substitution", "injury", "save"],
...
export const RefereeType = z.enum(
  ["referee", "assistant_referee", "fourth_official", "reserve_assistant_referee", "var", "assistant_var", "support_var"],
  `Referee type must be one of ${["referee", "assistant_referee", "fourth_official", "reserve_assistant_referee", "var", "assistant_var", "support_var"].join(", ")}`
)
...
export const GoalExecutionEnum = z.enum(
  ["tap_in", "header", "volley", "half_volley", "chip_lob", "bicycle_kick", "curler", "backheel", "deflection", "own_goal", "long_range", "unknown"],
