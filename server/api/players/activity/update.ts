export default defineEventHandler(async event => {
      ...
      CALL (*) {
        WHEN f:Doubles THEN {
          WHEN s:Winner AND r.round = 'Final' THEN {
            MATCH (r1:Round:Doubles {id: $eid || ' W'})
          ...
          OPTIONAL MATCH (qr:Round:Singles {id: $eid || ' Q'})
          OPTIONAL MATCH (q3:Round {id: $eid || ' Q3'})
          OPTIONAL MATCH (q2:Round {id: $eid || ' Q2'})
          CALL (*) {
            WHEN s:Winner AND r.round = 'Final' THEN {
              MATCH (r1:Round:Singles {id: $eid || ' W'})
  ...
  console.log(
    `Notifications for activity update: `,
