              ...
              ULink,
              {
                ...
                to: {
                  ...
                  params: {
                    ...
                    edId: `580${row.original.year}-${tour.value}`,
              ...
              ULink,
              {
                ...
                to: {
                  ...
                  params: {
                    id: "520",
                    name: "french-open",
                    edId: `520${row.original.year}-${tour.value}`,
                    year: row.original.year,
                    tour: tour.value
                  }
                }
              ...
              ULink,
              {
                ...
                to: {
                  ...
                  params: {
                    id: "540",
                    name: "wimbledon",
                    edId: `540${row.original.year}-${tour.value}`,
                    year: row.original.year,
                    tour: tour.value
                  }
                }
              ...
              ULink,
              {
                ...
                to: {
                  ...
                  params: {
                    id: "560",
                    name: "us-open",
                    edId: `560${row.original.year}-${tour.value}`,
                    year: row.original.year,
                    tour: tour.value
                  }
                }
              ...
              ULink,
              {
                ...
                to: {
                  ...
                  params: {
                    id: "605",
                    name: "finals",
                    edId: `605${row.original.year}-${tour.value}`,
                    year: row.original.year,
                    tour: tour.value
                  }
                }
              ...
              ULink,
              {
                ...
                to: {
                  ...
                  params: {
                    id: "96",
                    name: "olympics",
                    edId: `96${row.original.year}-${tour.value}`,
                    year: row.original.year,
                    tour: tour.value
                  }
                }
